...
const autos = [
  ...
  $(".snackbar").click( function(){
    ...
    toggleMenu(menuIsShowing, ".categories", "showMenu", "removeClass",
               "addClass");
  });
  ...
  $(".category-item").click(function(){
    ...
    toggleMenu(subIsShowing, subcategories, "", "slideUp", "slideDown");
  })
/* HELPER FUNCTIONS */
...
function toggleMenu(initialToggleState, element, arg, toggleAction1,
                    toggleAction2) {
